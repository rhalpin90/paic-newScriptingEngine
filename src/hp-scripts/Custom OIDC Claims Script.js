 ...
 * Modified by HealthPartners 2021
 *
...
(function () {
    ...
    utils.setScopeClaimsMap({
        ...
        phone: ['phone_number'],
      	healthpartners: [
          'com.healthpartners/username',
          'com.healthpartners/global_id',
          'com.healthpartners/global_id2',
          'com.healthpartners/guid',
          'com.healthpartners/account_id',
          'com.healthpartners/cg',
          'com.healthpartners/cg_id',
          'com.healthpartners/security_level',
          'com.healthpartners/memberNumber',
          'com.healthpartners/epiId',
          'com.healthpartners/virtuwellId',
          'com.healthpartners/receiverId',
          'com.healthpartners/emailUpdated',
        ]
    });
    ...
    utils.setClaimResolvers({
        ...
        */
        ...
        'com.healthpartners/username': utils.getUserProfileClaimResolver('uid'),
        'com.healthpartners/global_id': utils.getUserProfileClaimResolver('fr-attr-iint1'),
        'com.healthpartners/global_id2': utils.getUserProfileClaimResolver('fr-attr-iint2'),
        'com.healthpartners/account_id': utils.getUserProfileClaimResolver('fr-attr-iint3'),
        'com.healthpartners/guid': utils.getUserProfileClaimResolver('fr-attr-str1'),
        'com.healthpartners/cg': utils.getUserProfileClaimResolver('fr-attr-istr1'),
        'com.healthpartners/cg_id': utils.getUserProfileClaimResolver('fr-attr-istr2'),
        'com.healthpartners/security_level': utils.getUserProfileClaimResolver('fr-attr-str2'),
        'com.healthpartners/memberNumber': utils.getUserProfileClaimResolver('fr-attr-istr3'),
        'com.healthpartners/epiId': utils.getUserProfileClaimResolver('fr-attr-iint4'),
        'com.healthpartners/virtuwellId': utils.getUserProfileClaimResolver('fr-attr-iint5'),
        'com.healthpartners/receiverId': utils.getUserProfileClaimResolver('fr-attr-istr4'),
        'com.healthpartners/emailUpdated': function () {
            return session.getProperty('emailUpdated') ? true:false;
        }
    });
